...
#ifndef TEXTREADER_SWIFT_H
#define TEXTREADER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TextReader",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC10TextReader19AudioSessionManager")
...
SWIFT_CLASS("_TtC10TextReader13SpeechManager")
@interface SpeechManager : NSObject <AVSpeechSynthesizerDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
